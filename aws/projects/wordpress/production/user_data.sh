...
sudo -u www-data wp core install --url='http://www.wordpress-prod.com' --title='Blog Title' --admin_user='adminuser' --admin_password='letmeinn' --admin_email='email@domain.com'
